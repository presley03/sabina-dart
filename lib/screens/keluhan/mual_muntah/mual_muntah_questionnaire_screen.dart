...
class MualMuntahQuestionnaireScreen extends StatelessWidget {
      ...
      builder: (context, model, child) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Text('Kuesioner Mual Muntah', style: TextStyle(color: Colors.black)),
  ...
  Widget _buildProgressIndicator(MualMuntahModel model) {
  ...
  Widget _buildQuestionCard(BuildContext context, MualMuntahModel model) {
    return Card(
  ...
  Widget _buildAnswerButtons(BuildContext context, MualMuntahModel model) {
    return Row(
