...
class BengkakQuestionnaireScreen extends StatelessWidget {
      ...
      builder: (context, model, child) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Text('Kuesioner Bengkak', style: TextStyle(color: Colors.black)),
  ...
  Widget _buildProgressIndicator(BengkakModel model) {
  ...
  Widget _buildQuestionCard(BuildContext context, BengkakModel model) {
    return Card(
  ...
  Widget _buildAnswerButtons(BuildContext context, BengkakModel model) {
    return Row(
