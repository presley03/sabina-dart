        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ResultHeroArch(
                  eyebrow: l10n.preeklampsiaTitle,
                  severity: severity,
                ...
                const SizedBox(height: 16),
                ResultTrendChart(type: ScreeningResultService.preeklampsia),
                const SizedBox(height: 16),
                ResultRecommendationList(
                  title: l10n.yangBisaDilakukan,
                  items: [
                    l10n.preeklampsiaTip1,
                    l10n.preeklampsiaTip2,
                    l10n.preeklampsiaTip3,
                    l10n.preeklampsiaTip4,
                  ],
                  showConsultCta: severity == ResultSeverity.high,
                  consultMessage:
                      l10n.resultConsultWhatsAppMessage(l10n.preeklampsiaTitle),
                ),
                const SizedBox(height: 16),
