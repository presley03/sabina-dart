...
class QuestionnaireScreenModern extends StatelessWidget {
      ...
      builder: (context, model, child) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Text('Kuesioner Preeklamsia', style: TextStyle(color: Colors.black)),
  ...
  Widget _buildProgressIndicator(PreeclampsiaScreeningModel model) {
  ...
  Widget _buildQuestionCard(BuildContext context, PreeclampsiaScreeningModel model) {
    return Card(
  ...
  Widget _buildAnswerButtons(BuildContext context, PreeclampsiaScreeningModel model) {
    return Row(
