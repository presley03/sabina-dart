# Syarat & Ketentuan Layanan - SABINA
...
Dengan mengunduh, menginstal, atau menggunakan aplikasi SABINA ("Aplikasi"), Anda setuju terikat oleh syarat dan ketentuan ini ("Perjanjian"). Jika Anda tidak setuju dengan bagian mana pun, mohon jangan gunakan Aplikasi.
...
**Hasil kuesioner dan skrining dalam Aplikasi ini hanya bersifat informatif** berdasarkan jawaban yang Anda berikan. Hasil ini tidak dapat menggantikan pemeriksaan fisik dan diagnosis oleh tenaga kesehatan berlisensi.

**Jika Anda mengalami gejala darurat:**
- Hubungi ambulans: **118**
- Kunjungi UGD rumah sakit terdekat
- Jangan menunda dengan mencoba mencari informasi di Aplikasi terlebih dahulu

---

## 6. Batasan Tanggung Jawab

### 6.1 Aplikasi Disediakan "Sebagaimana Adanya"
...
- Pembaruan aplikasi mungkin memerlukan migrasi data
- Performa bergantung pada spesifikasi perangkat pengguna
...
## 9. Penghentian Penggunaan

Anda dapat berhenti menggunakan Aplikasi kapan saja dengan uninstall dari perangkat Anda. Semua data yang tersimpan lokal akan terhapus otomatis.

---

## 10. Hukum yang Berlaku

Perjanjian ini diatur oleh hukum **Republik Indonesia**, khususnya:

✅ **UU No. 36 Tahun 2009** — Kesehatan
✅ **UU ITE No. 19 Tahun 2016** — Informasi & Transaksi Elektronik
...
Jika ada perubahan material, kami akan memberitahukan melalui notifikasi in-app. Penggunaan berkelanjutan setelah perubahan berarti Anda menerima syarat yang diperbarui.
